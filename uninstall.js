...
const binp = path.join(cargoDir, "bin", "postgres-dv");

if (fs.existsSync(binp)) {
  console.log("Uninstalling postgres-dv...");
  exec(`cargo uninstall postgres-dv`, (error, stdout, stderr) => {
    console.log(stdout);
    if (error || stderr) {
  ...
  console.log("postgres-dv not found skipping!");
}
